...
public class Dotprompt {
   ...
   */
  public CompletableFuture<Map<String, Object>> renderMetadata(String source) {
   ...
   * @return A future containing the resolved metadata as a map.
   */
  public CompletableFuture<Map<String, Object>> renderMetadata(
      String source, Map<String, Object> additionalMetadata) {
    try {
  ...
  /**
   * Internal method to render a pre-parsed Prompt with data and options.
   *
   * @param prompt The parsed prompt to render.
   * @param data The data to use for rendering.
   * @param options Additional options (overrides/defaults).
   * @return The rendered prompt.
   */
  private RenderedPrompt renderPromptInternal(
      Prompt prompt, Map<String, Object> data, Map<String, Object> options) {
    try {
