...
public class SpecTest {
  ...
  private void runTestGroup(Map<String, Object> group) throws Exception {
    ...
    Map<String, Map<String, Object>> tools =
        (Map<String, Map<String, Object>>) group.get("tools");
    ...
    for (Map<String, Object> test : tests) {
      ...
      try {
        ...
        // The JS test also calls renderMetadata and compares the non-messages fields
        Map<String, Object> metadataResult = dotprompt.renderMetadata(template, options).get();
        if (expectedOutput != null && metadataResult.containsKey("config")) {
          Map<String, Object> metaConfig = (Map<String, Object>) metadataResult.get("config");
          if (metaConfig != null) {
            Map<String, Object> metaOutput = (Map<String, Object>) metaConfig.get("output");
            if (metaOutput != null) {
              assertThat(metaOutput).isEqualTo(expectedOutput);
            }
          }
        }
        if (expectedInput != null && metadataResult.containsKey("config")) {
          Map<String, Object> metaConfig = (Map<String, Object>) metadataResult.get("config");
          if (metaConfig != null) {
            Map<String, Object> metaInput = (Map<String, Object>) metaConfig.get("input");
            if (metaInput != null) {
              assertThat(metaInput).isEqualTo(expectedInput);
            }
          }
        }
      } catch (Exception e) {
