# Dotprompt: Executable Generative AI Prompt Templates
...
The *dotprompt* Rust library can be used to render `.prompt` templates into the
[Common Model Interface](https://google.github.io/dotprompt/reference/model/).
