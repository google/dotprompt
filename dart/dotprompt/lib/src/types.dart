...
class DataArgument {
  ...
  @override
  int get hashCode =>
      Object.hash(input.hashCode, context, messages.hashCode, docs.hashCode);
...
class MediaContent {
  ...
  @override
  String toString() =>
      "MediaContent(contentType: $contentType, url: $url, data: $data)";
}
...
class MediaPart extends Part {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is MediaPart && media == other.media;
...
class ToolRequestPart extends Part {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ToolRequestPart && toolRequest == other.toolRequest;
...
class ToolResponsePart extends Part {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ToolResponsePart && toolResponse == other.toolResponse;
...
class DataPart extends Part {
  ...
  factory DataPart.fromJson(Map<String, dynamic> json) => DataPart(
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is DataPart && _mapEquals(data, other.data);
...
class PendingPart extends Part {
  ...
  factory PendingPart.fromJson(Map<String, dynamic> json) => PendingPart(
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PendingPart && pending == other.pending;
