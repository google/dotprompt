...
class Parser {
  ...
  static Prompt parse(String source) {
    ...
    return Prompt(template: _trimLeadingNewline(template), config: config);
  }

  /// Trims a single leading newline from the template.
  static String _trimLeadingNewline(String template) {
  ...
  static Map<String, dynamic> _convertYamlMap(Map yaml) {
