...
class RenderedPrompt {
  ...
  Map<String, dynamic>? get input =>
      config["input"] as Map<String, dynamic>?;

  /// Gets output configuration from config.
  Map<String, dynamic>? get output =>
      config["output"] as Map<String, dynamic>?;
  ...
  bool operator ==(Object other) =>
      ...
      other is RenderedPrompt &&
          _mapEquals(config, other.config) &&
  ...
  @override
  String toString() =>
      "RenderedPrompt(config: $config, messages: $messages)";
}
