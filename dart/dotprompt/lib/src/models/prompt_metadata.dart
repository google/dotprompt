...
class PromptMetadata {
  ...
  factory PromptMetadata.fromConfig(Map<String, dynamic> config) {
    ...
    for (final entry in config.entries) {
      if (entry.key.contains(".")) {
        ...
        if (parts.length == 2) {
          ...
          ext["${parts[0]}.${parts[1]}"] ??= {};
          ext["${parts[0]}.${parts[1]}"]![parts.sublist(2).join(".")] =
              entry.value;
        }
      }
    }
    ...
    return PromptMetadata(
      ...
      input: config["input"] != null
          ? InputConfig.fromJson(config["input"] as Map<String, dynamic>)
          : null,
      output: config["output"] != null
          ? OutputConfig.fromJson(config["output"] as Map<String, dynamic>)
          : null,
      tools: config["tools"] != null
          ? (config["tools"] as List).cast<String>()
          : null,
      toolDefs: config["toolDefs"] != null
          ? (config["toolDefs"] as List)
  ...
  factory PromptMetadata.fromJson(Map<String, dynamic> json) =>
      PromptMetadata.fromConfig(json);
    ...
    if (ext != null) {
      for (final entry in ext!.entries) {
        for (final subEntry in entry.value.entries) {
          result["${entry.key}.${subEntry.key}"] = subEntry.value;
        }
      }
    }
    return result;
...
class InputConfig {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is InputConfig;
  ...
  @override
  String toString() =>
      "InputConfig(schema: $schema, defaultValues: $defaultValues)";
}
...
class OutputConfig {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is OutputConfig;
