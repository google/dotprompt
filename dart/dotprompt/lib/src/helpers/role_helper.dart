...
class RoleHelper {
  ...
  static String createMarker(Role role) =>
      "$markerPrefix${role.value}$markerSuffix";

  /// Creates a role marker from a role string.
  static String createMarkerFromString(String role) =>
      "$markerPrefix$role$markerSuffix";
