...
import "package:dotprompt/src/parse.dart";
...
""");
        expect(result.config["model"], equals("gemini-pro"));
        expect(result.config["config"]["temperature"], equals(0.7));
        expect(result.config["config"]["maxOutputTokens"], equals(1024));
        expect(result.config["input"]["schema"]["name"], equals("string"));
        expect(result.config["input"]["default"]["name"], equals("User"));
