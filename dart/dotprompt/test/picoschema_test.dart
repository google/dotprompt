  ...
  group("Picoschema", () {
    group("toJsonSchema", () {
      ...
      test("handles optional fields", () {
        ...
        expect(result["properties"]?.containsKey("nickname"), isTrue);
      });
      ...
      test("handles field descriptions", () {
        ...
        expect(result["properties"]?["email"], equals({
          "type": "string",
      ...
      test("converts nested objects", () {
        ...
        expect(result["properties"]?["user"]?["type"], equals("object"));
        expect(
    ...
    group("isPicoschema", () {
      test("returns true for Picoschema", () {
        expect(
          Picoschema.isPicoschema({"name": "string"}),
          isTrue,
        );
      });

      test("returns false for JSON Schema with \$schema", () {
        expect(
