...
"""
This module provides classes and utilities designed to work with the `Dotprompt`
system for template rendering, dynamic partial resolution, tools integration,
and schema configuration. The main classes are `DotpromptOptions` and
`Dotprompt`.
